...
if (!empty($data) || (!empty($p) && !empty($s))) {
    ...
    if ($confirmed == AUTH_CONFIRM_ALREADY) {
        ...
        // ENVF: Fix a bug
        // In Moodle core, we redirect to edit.php here instead of the home page.
        // It means we will go to edit mode instead of home page (as the user is not completely setup).
